...
// Tech stacks from Jake's resume
const techStacks = [
...
export default function FullWidthTabs() {
  ...
  const initialItems = isMobile ? 2 : 2; // Show 2 projects initially
  ...
  return (
    <div className="md:px-[10%] px-[5%] w-full sm:mt-0 mt-[3rem] bg-[#030014] overflow-hidden" id="Portofolio">
      ...
      <div className="text-center pb-10" data-aos="fade-up" data-aos-duration="1000">
        <h2 className="inline-block text-3xl md:text-5xl font-bold text-center mx-auto text-transparent bg-clip-text bg-gradient-to-r from-[#3B82F6] to-[#9333EA]">
          <span style={{
            color: '#3B82F6',
            backgroundImage: 'linear-gradient(45deg, #3B82F6 10%, #9333EA 93%)',
